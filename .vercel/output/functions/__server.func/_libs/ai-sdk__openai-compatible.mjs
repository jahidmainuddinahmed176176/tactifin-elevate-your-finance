...
import { w as withoutTrailingSlash, h as createJsonErrorResponseHandler, p as postJsonToApi, j as combineHeaders, k as generateId, l as createEventSourceResponseHandler, m as isParsableJson, e as convertUint8ArrayToBase64, n as createJsonResponseHandler } from "./ai-sdk__provider-utils.mjs";
import { u as unionType, o as objectType, a as arrayType, s as stringType, l as literalType, e as numberType, h as enumType, j as anyType } from "./zod.mjs";
...
var createOpenAICompatibleCompletionChunkSchema = (errorSchema) => unionType([
  objectType({
    id: stringType().nullish(),
    created: numberType().nullish(),
    model: stringType().nullish(),

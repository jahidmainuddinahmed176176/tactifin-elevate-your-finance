...
const CirclePlay = createLucideIcon("circle-play", __iconNode$E);
const __iconNode$D = [
  ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
...
const MoonStar = createLucideIcon("moon-star", __iconNode$s);
const __iconNode$r = [
  [
    "path",
    {
...
const WalletMinimal = createLucideIcon("wallet-minimal", __iconNode$4);
const __iconNode$3 = [
  [
    "path",
    {

...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-OXQ_DOL5.mjs");
...
const manifest = {
  "47486d30f097d8c063c6524c7acf474c3dc33bde29bc270e20e66c205643db72": {
    functionName: "getMessages_createServerFn_handler",
    importer: () => import("./threads.functions-CV-4-HNt.mjs")
  },
  ...
  "5f15d9c6194c3264109b1c81741c60a8654b66a5caffc1ee319315a3a983394e": {
    ...
    importer: () => import("./admin.functions-Dhv459ze.mjs")
  },
  ...
  "abb0f390d0d9d5c002c238029f7d6ac7eceb5f795c2ff0103d4fb2cfd687a422": {
    ...
    importer: () => import("./chat.functions-CrOAMeny.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DLLEZnVG.mjs").then((n) => n.s),
    import("./start-DoB41uEO.mjs"),

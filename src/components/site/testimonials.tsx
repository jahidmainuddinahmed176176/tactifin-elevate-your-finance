    ...
    <section className="border-t border-border/40 py-28">
      <div className="mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-2xl text-center">
          <div className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Voices</div>
        ...
        <div className="mt-14 grid gap-5 md:grid-cols-3">
          {QUOTES.map((q) => (
            <figure key={q.a} className="flex flex-col justify-between rounded-2xl border border-border/60 bg-card p-7">
              ...
              <figcaption className="mt-8 flex items-center gap-3 border-t border-border/60 pt-5">
                <div className="flex h-9 w-9 items-center justify-center rounded-full bg-brand-gradient text-sm font-medium text-black">
                  {q.a[0]}
                </div>
                <div>

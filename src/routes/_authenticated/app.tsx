...
import { getTransactions, getBudgets, getGoals } from "@/lib/local-storage";
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-3">
            ...
            <Button asChild size="sm" variant="ghost" className="text-xs"><Link to="/goals">View all</Link></Button>
          </CardHeader>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-3">
            ...
            <Button asChild size="sm" variant="ghost" className="text-xs"><Link to="/budgets">View all</Link></Button>
          </CardHeader>
          <CardContent>
            {budgets.length === 0 ? (
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between pb-3">
          ...
          <Button asChild size="sm" variant="ghost" className="text-xs"><Link to="/transactions">View all</Link></Button>
        </CardHeader>
        <CardContent>
          {txns.length === 0 ? (

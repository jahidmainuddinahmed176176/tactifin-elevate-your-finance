...
export default function RewinderPage() {
  ...
  for (const t of txns) {
    if (t.type === "expense") allCategoryTotals[t.category] = (allCategoryTotals[t.category] ?? 0) + t.amount;
  }
    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Replay and analyse your financial history month by month.</p>
        </div>
        <Card>
          <CardContent className="flex flex-col items-center gap-3 py-16 text-center">
            ...
            <Button variant="outline" asChild><a href="/transactions">Go to Transactions</a></Button>
          </CardContent>
        </Card>
      </div>
    );
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl">Rewinder</h1>
        <p className="text-sm text-muted-foreground">Replay and analyse your financial history — income, expenses, and net worth month by month.</p>
      </div>

      {latestKey && (
        <div className="grid gap-4 sm:grid-cols-3">
          <Card>
            <CardHeader className="pb-2"><CardTitle className="text-xs font-medium text-muted-foreground">Income — {monthLabel(latestKey)}</CardTitle></CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader className="pb-2"><CardTitle className="text-xs font-medium text-muted-foreground">Expenses — {monthLabel(latestKey)}</CardTitle></CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader className="pb-2"><CardTitle className="text-xs font-medium text-muted-foreground">Net — {monthLabel(latestKey)}</CardTitle></CardHeader>
            <CardContent>
        ...
        <TabsContent value="categories" className="mt-4">
          <Card>
            ...
            <CardContent className="space-y-3">
              {sortedCategories.length === 0 ? <p className="text-sm text-muted-foreground">No expense data yet.</p> : (
